...
- [ ] Git tag `cargo install --git https://github.com/Mont3ll/pi-governance-rs --tag v1.0.1 pi-governance-rs` test.
...
- [ ] Post-publish `cargo install pi-governance-rs` verification.
